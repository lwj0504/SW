...
'''
    리스트를 원하는 모양으로 자르느 슬라이싱
'''
print('과일 리스트중 2,3,4번 과일은? ', fruits[1:4])    # 1번지 ~ 4번지 앞까지
print("과일 리스트중 1~3번 과일은? ", fruits[0:3])
print("과일 리스트중 1~3번 과일은? ", fruits[:3])       # 처음부터 2번지까지.

print("과일 리스트중 3번부터 마지막까지 과일은? ", fruits[2:])

print("과일 리스트 중에서 1,3,5번 과일은?",fruits[::2])
